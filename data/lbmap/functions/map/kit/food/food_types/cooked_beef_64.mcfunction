...
summon minecraft:item_frame -4 52 25 {Facing:5b,Invulnerable:1b,Tags:["lbm_food_cbeef_64"],Item:{id:"minecraft:cooked_beef",Count:1b}}
summon armor_stand -3.9 51.7 25 {CustomNameVisible:1b,NoGravity:1b,Small:1b,CustomName:'{"text":"64"}',Tags:[lbm_food_number],Invisible:1b,Invulnerable:1b}